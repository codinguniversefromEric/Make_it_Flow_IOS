...
let countPlus = fullText.filter { $0 == "+" }.count
let countMinus = fullText.filter { $0 == "-" }.count
let countEq = fullText.filter { $0 == "=" }.count
print("Count of + : \(countPlus)")
print("Count of - : \(countMinus)")
print("Count of = : \(countEq)")
