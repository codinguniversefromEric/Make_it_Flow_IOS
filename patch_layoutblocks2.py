...
# Since I just want to replace sortLayoutBlocks and sortRegionColumns completely:
# I will use substring replacement based on indices or a more forgiving regex.
start_index = content.find("    // MARK: - 2. 閱讀順序演算法 (XY-Cut / Projection Profile)")
end_index = content.find("    // MARK: - Style Mapping")
